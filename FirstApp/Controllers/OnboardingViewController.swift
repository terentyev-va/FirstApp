...
class OnboardingViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        collectionView.register(OnboardingCollectionViewCell.self,
                                forCellWithReuseIdentifier: idOnboardingCell)
        ...
        let firstScreen = OnboardingStruct(topLabel: "Have a good health",
                                           bottomLabel: "Being healty is all, no health is nothing. So why do not we",
                                           image: imageFirst)
        ...
        let thirdScreen = OnboardingStruct(topLabel: "Have nice body",
                                           bottomLabel: "Bad body shape, poor sleep, lack of strenght, weight gain, weak bones, easily traumatized body, depressed, stressed, poor metabolism, poor resistance",
                                           image: imageThird)
